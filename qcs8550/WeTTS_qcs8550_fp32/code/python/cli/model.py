...
# from wetts_local.cli.frontend import Frontend
# from wetts_local.cli.hub import Hub

# from frontend import Frontend
# from hub import Hub

from cli.frontend import Frontend
from cli.hub import Hub
import time
...
class Model:
    ...
    def synthesis(self, text: str, speaker: str = 'default'):
        ...
        t2=time.time()
        vits_cost=(t2-t1)*1000
        # print(f"vits inference cost :{vits_cost}ms")
        audio = outputs[0][0][0]
        audio = (audio * 32767).astype(np.int16)
        return phonemes, audio,fronted_cost,vits_cost
...
def load_model():
    ...
    front_dir = f'{current_path}/models/QCS8550/FP32/frontend'
    backend_dir = f'{current_path}/models/QCS8550/FP32/multilingual'
