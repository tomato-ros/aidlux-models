...
class AidliteTool:
    def load_encoder(self,model_path):
        ...
        self.output_shapes = [[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64],[1,8,256,64]]
    ...
    def decoder_infer(self,data):
        ...
        for i in range(1):
            ...
            result = self.decoder.invoke()
            print("decoder time:",time.time()-begin_time)
        res_list=[]
    ...
    def encoder_infer(self,data):
        ...
        for i in range(1):
            begin_time=time.time()
            result = self.encoder.invoke()
            print("encoder time:",time.time()-begin_time)
        res_list=[]
